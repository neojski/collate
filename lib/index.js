...
exports.toIndexableString = function (key) {
  ...
  var FACTOR_DIGITS = 20; //empirically seems safe

  function numToIndexableString(num) {

    // convert number to exponent format for easier and
    // more succinct sorting
  ...
  if (key === null) {
    ...
    return result + numToIndexableString(key);
